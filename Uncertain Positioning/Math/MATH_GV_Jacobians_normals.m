...
syms a b c x y xi yi xj yj ri rj t
assume([a b c x y xi yi xj yj ri rj t],'real');
assume([c ri rj],'positive');
...
FJni = matlabFunction( Jni, 'File','FJni_GV');
FJnj = matlabFunction( Jnj, 'File','FJnj_GV');

FJi = matlabFunction( Ji, 'File','FJi_GV');
FJj = matlabFunction( Jj, 'File','FJj_GV');

Fni = matlabFunction( ni, 'File','Fni_GV');
Fnj = matlabFunction( nj, 'File','Fnj_GV');
